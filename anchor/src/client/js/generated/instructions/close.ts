...
export type CloseInput<
  ...
  TAccountSimplecollection extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountSimplecollection>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountSimplecollection> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.simplecollection),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountSimplecollection>;
...
> = {
  ...
  accounts: {
    ...
    simplecollection: TAccountMetas[1];
  };
